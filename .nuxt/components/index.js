...
export { default as Parceiros } from '../../components/Parceiros.vue'
...
export const LazyParceiros = import('../../components/Parceiros.vue' /* webpackChunkName: "components/Parceiros'}" */).then(c => c.default || c)
