...
// Module
exports.push([module.i, "nav{background-color:#ddd;width:100%;height:5rem;font-size:2.5rem;color:var(--pink);font-weight:200}header{height:80vh;display:flex;align-items:center}header h1{font-size:2.5rem}header p{font-size:1.5rem}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=cfca6d58&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<nav class=\"flex center\"><div><i aria-hidden=\"true\" class=\"fa fa-bars\"></i></div> <div><img src=\"hg.png\" class=\"logo\"></div> <div></div></nav> <header class=\"container\"><div class=\"container\"><h1 class=\"text dark boldest\">TEXTO INTERÁTIVO SOBRE O BANNER</h1> <p class=\"text pink\">\n        AQUI  USAR  UM BANNER COM IMAGEM DE FUNDO\n      </p></div></header>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=cfca6d58&
